      ...
      <header className="border-b border-border/40 backdrop-blur-xl sticky top-0 z-40 bg-background/80">
        <div className="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => router.push("/")}
              className="w-11 h-11 rounded-xl bg-gradient-to-br from-accent/30 to-accent/10 flex items-center justify-center border border-accent/20 focus:outline-none"
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-4">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 rounded-lg bg-card/40 border border-border/50 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-accent/40 focus-border-accent/40 smooth-transition"
                />
              </div>
              {/* Filter */}
              <div className="flex items-center gap-2">
                <Select value={filterType} onValueChange={setFilterType}>
                  <SelectTrigger className="w-full min-w-[140px] bg-card/40 border border-accent/40 focus:ring-accent/40 focus:border-accent/40 text-foreground rounded-lg shadow-sm flex items-center gap-2">
                    <span className="flex items-center">
                      <Filter className="w-4 h-4 text-muted-foreground mr-2" />
                      <SelectValue />
                    </span>
                  </SelectTrigger>
                  <SelectContent className="bg-card/90 border border-accent/30 text-foreground rounded-lg shadow-lg">
          ...
          <div className="lg:col-span-2">
            {selectedToken ? (
              <TokenDetail token={selectedToken} onBurnClick={onBurnClick} />
            ) : (
              <div
